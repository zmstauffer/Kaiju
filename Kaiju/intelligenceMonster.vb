Public Class intelligenceMonster
    Inherits Kaiju
    ...
    Public Sub New()
        ...
        'define actions
        action1 = New ActionDefinition("intelligence", 1, "Intelligence Strike", fightType)
        action2 = New ActionDefinition("strength", 1, "NONE", fightType)
        action3 = New ActionDefinition("strength", 1, "NONE", fightType)

        Dim ultAction1 = New ActionDefinition("intelligence", 1, "Ult Strike", fightType)
